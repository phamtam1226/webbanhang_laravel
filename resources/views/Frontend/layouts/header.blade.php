        ...
        <div class="container">
            ...
            <div class="top-bar right">
                ...
                <ul class="horizontal-menu">
                    ...
                    ?>
                        <li><a href="{{URL::to('/login_checkout')}}" class="login-link"><i class="biolife-icon icon-login"></i>Đăng xuất</a></li>
                ...
                <div class="col-lg-6 col-md-7 hidden-sm hidden-xs">
                    <div class="primary-menu">
                        <ul class="menu biolife-menu clone-main-menu clone-primary-menu" id="primary-menu" data-menuname="main menu">
                            ...
                            <li class="menu-item"><a href="{{URL::to('/cart')}}">Giỏ hàng </a></li>
                            ...
                            <?php
                                    ...
                                    ?>
                                        <li class="menu-item"><a href="{{URL::to('/checkout')}}">Thanh toán</a></li>
