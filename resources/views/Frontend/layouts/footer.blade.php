            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-9">
                    <section class="footer-item">
                        <a href="index-2.html" class="logo footer-logo"><img src="assets/images/sach_logo.jpg" alt="biolife logo" width="135" height="34"></a>
                            ...
                            <ul class="contact-lines">
                                ...
                                <li>
                                    <p class="info-item">
                                        ...
                                        <b class="desc">Email:  phambatam@gmai.com</b>
                                    </p>
                                </li>
                                <li>
                                    <p class="info-item">
                                        <i class="biolife-icon icon-clock"></i>
                                        <b class="desc">Thời gian: 7 ngày một tuần từ 10:00 sáng</b>
                                    </p>
                                </li>
                            </ul>
                        </div>
